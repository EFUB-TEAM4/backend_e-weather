...
import efub.team4.backend_eweather.global.outh.info.OAuth2UserInfoFactory;
...
import static efub.team4.backend_eweather.global.outh.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        User userEntity = userRepository.findByEmail(userInfo.getEmail());
        ...
        // DB 저장
        UserRefreshToken userRefreshToken = userRefreshTokenRepository.findByUserId(userEntity.getId());
        if (userRefreshToken != null) {
            userRefreshToken.setRefreshToken(refreshToken.getToken());
        } else {
            userRefreshToken = new UserRefreshToken(userEntity.getId(), refreshToken.getToken());
